            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4 md:mb-6">{t("title")}</h2>
                        <p className="text-zinc-300 text-base md:text-lg mb-8 md:mb-10 max-w-xl mx-auto px-2">
                            {t("description")}
                        </p>

                        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center px-2">
                            <a href="mailto:azzeddinefejri@gmail.com" className="w-full sm:w-auto px-6 md:px-8 py-3.5 rounded-full bg-white text-black font-bold flex items-center justify-center gap-2 hover:bg-zinc-200 transition-colors text-sm md:text-base">
                                <Mail size={18} /> {t("cta")}
                            </a>
                            <a href="tel:+212636232071" dir="ltr" className="w-full sm:w-auto px-6 md:px-8 py-3.5 rounded-full border border-white/20 bg-white/5 backdrop-blur-sm font-bold flex items-center justify-center gap-2 hover:bg-white/10 transition-colors text-sm md:text-base">
                                <Phone size={18} /> +212 636 232 071
                            </a>
                        </div>
